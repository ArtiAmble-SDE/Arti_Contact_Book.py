...
root.title('ARTI CONTACT BOOK')
root.resizable(0,0)
contactlist = [
    ['Sakshi Khutwad','369854712'],
    ['Gaurav Poman', '521155222'],
    ['Abhijeet Savant', '78945614'],
    ['Shraddha Gaikwad', '58745246'],
    ['Mohit Poman', '5846975'],
    ['Ketan Taware', '5647892'],
    ['Sid Gadhave', '89685320'],
    ['Pranjal Zende', '98564785'],
    ['Vaibhav Ladkat','85967412']
    ]
